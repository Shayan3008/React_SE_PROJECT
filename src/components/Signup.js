            ...
            <div className='flex h-full'>
                ...
                <div className='container w-full flex justify-center items-center '>
                    <div className='text-center flex flex-col w-7/12'>
                        <h1 className='font-bold text-2xl p-2'>Shopping Store</h1>
                        <input onChange={(e) => {
                        ...
                        <button className='bg-blue-400 w-6/12 m-auto text-white font-bold text-base rounded mt-2 p-2'>Sign UP</button>
                        <p onClick={() => {
                            console.log('Jello')
                            history('/')
